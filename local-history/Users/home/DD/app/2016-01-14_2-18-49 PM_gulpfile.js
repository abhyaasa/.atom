...
var cmdAliases = {
    ...
    si: 'gulp is -i',
    bi: 'gulp build',
    ei: 'gulp; ionic emulate ios -l -c -s | tee tmp/ei.txt | egrep -i error',
    ri: 'gulp; ionic run ios -l -c -s --device'
};
// TODO egrep above doesn't work when emulate hangs, ri needs this also
