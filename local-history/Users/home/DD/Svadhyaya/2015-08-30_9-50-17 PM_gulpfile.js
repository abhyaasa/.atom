...
var utestMessage = ('Single karma run, with option -m PATTERN argument to ' +
    'only run tests with message string (first "it" arg) matching PATTERN.');
// See http://stackoverflow.com/questions/8527786 Rimian post.

gulp.task('utest', utestMessage, function () {
