...
gulp.task('is',
    '[-a|-i|-l] for ionic serve for android, ios, or (default) both',
    ['default'],
    function () {
...
gulp.task('index', 'Inject script and css elements into www/index.html', ['config'], // wait for sass to complete
