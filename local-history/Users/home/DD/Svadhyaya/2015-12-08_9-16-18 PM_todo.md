...
Some are recorded as Atom todo-show (ctrl-shift-T) comments. The following tags are in use, in approximately decreasing order of priority: XXX (remove me), FIXME, TODO, REVIEW, ANDROID, HACK, PUBLISH, REVIEW, FUTURE.
