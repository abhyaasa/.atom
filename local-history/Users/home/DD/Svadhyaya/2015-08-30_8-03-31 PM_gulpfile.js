...
paths.jshint = paths.indexScripts.concat(
...
var karmaConf = {
    // karma.conf.js with app files and logLevel
    ...
    // exclude: ['views/**/*ispec.js', 'js/utils.uspec.js']
};

var testFiles = paths.jshint;

gulp.task('utest', 'Unit tests', function () {
    // Be sure to return the stream
    var conf = JSON.parse(JSON.stringify(karmaConf));
    conf.action = 'run';
    conf.files = conf.files.concat(['js/*.js', 'views/**/*.js']);
    return gulp.src([])
