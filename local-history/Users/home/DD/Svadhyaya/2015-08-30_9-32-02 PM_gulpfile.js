...
// http://stackoverflow.com/questions/8527786 Rimian post doesn't work:
// doesn't recognize client attribute, and probably other issues.
...
gulp.task('utest', 'Unit tests', function () {
    ...
    return gulp.src([])
        .pipe(karma({
            ...
            client: {
                args: ['--grep', 'should invoke jasmine spy handler']
            },
            action: 'run'
        }))
