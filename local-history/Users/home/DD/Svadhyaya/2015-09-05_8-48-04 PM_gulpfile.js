...
gulp.task('watch', ['index'], function () { // index added
    gulp.watch(paths.sass, ['sass']);
    // gulp.watch([paths.indexScripts], ['index']); // added line XXX
});
...
gulp.task('ionic', 'Run instead of default by ionic', ['watch']); // XXX
...
gulp.task('index', 'Inject script and css elements into www/index.html',
    ['sass'], // wait for sass to complete
...
gulp.task('end', 'Synchronous end of default sequence', ['index']);
