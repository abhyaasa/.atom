...
.run(function ($log, $ionicPlatform, $rootScope, $state, restoreSettings, settings, mode, Card, Deck) {
    ...
    // hack to avoid circular service dependency
    Deck.Card = Card;
    $log.debug('run', JSON.stringify(Card));
    // Deck.setCard(Card);
