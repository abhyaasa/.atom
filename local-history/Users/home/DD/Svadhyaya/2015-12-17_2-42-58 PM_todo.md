...
There are lots of things to do. Some are recorded as Atom todo-show (ctrl-shift-T) comments. The following tags are in use, in approximately decreasing order of priority: XX-X (used without the dash, indicating temporary fixtures to be removed), FIXME, TODO, HACK, REVIEW, ANDROID, PUBLISH, FUTURE.
